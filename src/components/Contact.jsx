...
function Contact() {
  ...
  return (
    <>
      ...
      <div className='flex justify-center'>
        <div className="card w-[300px] bg-red-100 shadow-xl ">
          ...
          <div className="card-body">
            ...
            <div className="card-actions justifzy-end">
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Development team */}
      <div>
        <p className='text-5xl font-bold text-center m-9'>Development <span className='text-red-500'>Head</span></p>
      </div>
      <div className='p-4'>
          ...
          <div className="card w-[300px] bg-red-100 shadow-xl ">
            ...
            <div className="card-body">
              ...
              <div className='flex flex-row justify-evenly pt-5'>
                ...
                {/* <button className="btn-circle" onClick={() => window.open('https://www.instagram.com', '_blank')}>
              ...
              {/* <div className='flex flex-row justify-evenly justify-center pt-5'>
                ...
                <button className="btn-circle" onClick={() => openInNewTab("https://www.linkedin.com/in/champa-lal-suthar-325040253/")}>
